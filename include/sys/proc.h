...
struct Queue {
    struct proc *q[NR_TASKS + NR_PROCS];
    int front;
    int tail;
    int size;
    int timeslice;
...
#define STACK_SIZE_TOTAL (STACK_SIZE_TTY + STACK_SIZE_SYS + STACK_SIZE_HD + STACK_SIZE_FS + STACK_SIZE_MM + STACK_SIZE_INIT + STACK_SIZE_TESTA + STACK_SIZE_TESTB + STACK_SIZE_TESTC)
